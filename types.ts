...
export type DepartmentId = 'home' | 'assistance' | 'registration' | 'tracking' | 'events' | 'cancellations' | 'billing' | 'commercial' | 'legal';
...
export interface Submodule {
  ...
  pdfType?: 'termo_acordo' | 'cobranca' | 'recibo' | 'termo_cancelamento' | 'entrega_veiculo' | 'termo_acordo_amparo' | 'termo_recebimento_rastreador' | 'termo_pecas';
